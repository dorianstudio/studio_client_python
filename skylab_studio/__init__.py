...
class api:  # pylint: disable=invalid-name
    ...
    def list_jobs(self):
        ...
        return self._api_request("jobs", "GET")

    def create_job(self, payload=None):
        """API call to create a job"""
        return self._api_request("jobs", "POST", payload=payload)
    ...
    def list_profiles(self):
        ...
        return self._api_request("profiles", "GET")

    def create_profile(self, payload=None):
        """API call to create a profile"""
        return self._api_request("profiles", "POST", payload=payload)
    ...
    def list_photos(self):
        ...
        return self._api_request("photos", "GET")

    def create_photo(self, payload=None):
        """API call to create a photo"""
        return self._api_request("photos", "POST", payload=payload)
